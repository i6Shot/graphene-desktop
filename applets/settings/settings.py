...
from battery import VosBatteryIcon, VosBatteryInfo, battery_info_get_default
from volume import VosVolumeIcon
...
class VosSettingsPopup(Gtk.Window):
    ...
    def create_layout(self):
        ...
        logoutBox.pack_start(Gtk.Button.new_from_icon_name("system-lock-screen-symbolic", Gtk.IconSize.DND), False, False, 0)
        logoutBox.pack_start(Gtk.Button.new_from_icon_name("system-shutdown-symbolic", Gtk.IconSize.DND), False, False, 0)
        logoutBox.pack_start(Gtk.Button.new_from_icon_name("emblem-system-symbolic", Gtk.IconSize.DND), False, False, 0)
        ...
        userBox.pack_start(userNameBox, False, False, 0)
