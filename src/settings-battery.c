...
{
  GrapheneBatteryIcon *icon = GRAPHENE_BATTERY_ICON(g_object_new(GRAPHENE_TYPE_BATTERY_ICON, "use-foreground-color", TRUE, NULL));
  cmk_icon_set_size(CMK_ICON(icon), size);
  return icon;
}
